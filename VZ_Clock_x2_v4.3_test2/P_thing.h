    ...
    <head>
        ...
        <script type = "text/javascript">
            ...
            function set_thing_ust(submit) {
                ...
                server += "&writeFild1=" + val('writeFild1') + "&writeFild2=" + val('writeFild2') + "&writeFild3=" + val('writeFild3') + "&writeFild4=" + val('writeFild4');
                server += "&writeFild5=" + val('writeFild5') + "&writeFild6=" + val('writeFild6') + "&writeFild7=" + val('writeFild7') + "&writeFild8=" + val('writeFild8');
                send_request(submit,server);
            }
        </script>
    </head>
                    ...
                    <table id="table__font" class = "table">
                        ...
                        <tr>
                            ...
                            <td><select id = "writeFild1">
                                ...
                                <option value = "6"> eCO2 </option>
                                <option value = "7"> TVOC </option>
                            </select></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><span class="opt_cn"> {{nameField8}} </span></td>
                            <td><select id = "writeFild8">
                                <option value = "0"> НЕТ </option>
                                <option value = "1"> tD </option>
                                <option value = "2"> tU </option>
                                <option value = "3"> tH </option>
                ...
                <center>
                    ...
                    <table id="table__font" class = "table">
                        ...
                        <tr>
                            ...
                            <td><select id = "thing1">
                                <option value = "1"> {{nameReadField1}} (1) </option>
                                <option value = "2"> {{nameReadField2}} (2) </option>
                                <option value = "3"> {{nameReadField3}} (3) </option>
                                <option value = "4"> {{nameReadField4}} (4) </option>
                                <option value = "5"> {{nameReadField5}} (5) </option>
                                <option value = "6"> {{nameReadField6}} (6) </option>
                                <option value = "7"> {{nameReadField7}} (7) </option>
                                <option value = "8"> {{nameReadField8}} (8) </option>
                            </select></td>
                        </tr>
                        <tr>
