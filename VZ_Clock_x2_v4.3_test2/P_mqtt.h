    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_mqtt_ust(submit) {
                ...
                server += "&mqtt_pub_temp=" + val('mqtt_pub_temp') + "&mqtt_pub_tempUl=" + val('mqtt_pub_tempUl') + "&mqtt_pub_tempH=" + val('mqtt_pub_tempH') + "&mqtt_pub_hum=" + val('mqtt_pub_hum') + "&mqtt_pub_press=" + val('mqtt_pub_press') + "&mqtt_pub_alt=" + val('mqtt_pub_alt');
    ...
    <body onload = "load('/configs_mqtt');">
        ...
        <central-unit>
            ...
            <div id="main_unit">
                ...
                <table>                    
                    <tr>
                        <td align = "right"><span class="opt_cn">Публикация температуры в доме</span></td>
                        <td><input type="text" class="field form-control" id="mqtt_pub_temp" value="{{mqtt_pub_temp}}" pattern="[-\w\s#@/]{1,24}"></td>
                    </tr>
                    <tr>
                        <td align = "right"><span class="opt_cn">Публикация температуры на улице</span></td>
                        <td><input type="text" class="field form-control" id="mqtt_pub_tempUl" value="{{mqtt_pub_tempUl}}" pattern="[-\w\s#@/]{1,24}"></td>
                    </tr>
                    <tr>
                        <td align = "right"><span class="opt_cn">Публикация температуры доп.</span></td>
                        <td><input type="text" class="field form-control" id="mqtt_pub_tempH" value="{{mqtt_pub_tempH}}" pattern="[-\w\s#@/]{1,24}"></td>
                    </tr>
                    <tr>
                ...
                <br>
                <hr>
                <span class="save_booton" onclick="get_html('thing.vz');"><b>Настройка ThingSpeak</b></span>
                <br>
            </div>
            <div>
