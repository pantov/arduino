    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_sgp(submit) {
                server = "/sgp?eCo2Led=" + val_sw('eCo2Led') + "&sgpCo2LivelAlarm=" + val('sgpCo2LivelAlarm') + "&eCo2AlarmEsp=" + val_sw('eCo2AlarmEsp') + "&eCo2AlarmMqtt=" + val_sw('eCo2AlarmMqtt') + "&mqtt_pub_eco2=" + val('mqtt_pub_eco2');
                server += "&tvocLed=" + val_sw('tvocLed') + "&sgpTvocLivelAlarm=" + val('sgpTvocLivelAlarm') + "&tvocAlarmEsp=" + val_sw('tvocAlarmEsp') + "&tvocAlarmMqtt=" + val_sw('tvocAlarmMqtt') + "&mqtt_pub_tvoc=" + val('mqtt_pub_tvoc');
                server += "&sgpCorr=" + val_sw('sgpCorr') + "&sgpCorrMan=" + val_sw('sgpCorrMan') + "&sgpCorrTemp=" + val('sgpCorrTemp') + "&sgpCorrHumi=" + val('sgpCorrHumi');
            ...
            <div id="main_unit">
                ...
                <center>
                  ...
                  <table>
                      ...
                      <tr>
                          <td align = "right"><span class="opt_cn">Отправлять в информ топик MQTT</span></td>
                          <td><input type="checkbox" class="checkbox" id="eCo2AlarmMqtt" name="switch-btn"></td>
                      </tr>
                      <tr>
                          <td align = "right"><span class="opt_cn">Топик для отправки данных о eCO₂</span></td>
                ...
                <center>
                  ...
                  <table>
                      ...
                      <tr>
                          <td align = "right"><span class="opt_cn">Топик для отправки данных о TVOC</span></td>
                ...
                <center>
                    ...
                    <table>
                        <tr>
                            <td align = "right"><span class="opt_cn">Учитывать компенсационные данные</span></td>
                            <td><input type="checkbox" class="checkbox" id="sgpCorr" name="switch-btn"></td>
                        </tr>
                        <tr>
                            <td align = "right"><span class="opt_cn">Ручной ввод компенсационных параметров</span></td>
                            <td><input type="checkbox" class="checkbox" id="sgpCorrMan" name="switch-btn" ></td>
                        </tr>
                    </table>
                    <div class="informer">
                        <span class="opt_cn">В ручном режиме возможно задать собственные параметры. Если ручной режим отключен, то данные будут подтягиваться от BME280 (при его наличии).</span>
                    </div>
                    <table>
                        <tr>
