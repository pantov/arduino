bool loadConfig() {                                                // Завантаження даних збереженних в файлі config.json
  ...
  snprintf(mqtt_pub_tempH, 24, "%s", (doc["mqtt_pub_tempH"].as<String>()).c_str());
...
bool saveConfig() {
  ...
  doc["mqtt_pub_tempH"] = mqtt_pub_tempH;
